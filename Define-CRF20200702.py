...
def mapSDS(dfCRF, dfSDS, dfSdsDic, dfIgCdash, dfSanofiCdash, dfIgSdtm,
    ...
    dfStdAllSet = dfNodupVeriable.loc[:, [
        ...
        "CRFVISIT", "CRFVISID", "CRFVISOD","CRFVISDY","CRFVISDU", "CRFDSLAB", "CRFVAR", "CRFDES",
        "CRFDIC", "CRFDOM", "CDASHTYPE", "CRFVAL"
    ]]
...
if __name__ == '__main__':
    ...
    if fileProfile:
        ...
        dfACRF = mapSDS(dfCRF, dfSDS, dfSdsDic, dfIgCdash, dfSanofiCdash,
                        dfIgSdtm, dfSanofiSdtm)
        ...
        with open(
                strCRFPath + "\\" + strFilename + strCurrentDatetime + ".mcrf",
                'w') as f:
            # print(dfACRF.to_json(orient='records'));
            f.write(json.dumps(dictMeta))
        dfACRF.to_csv(strCRFPath + "\\" + strFilename + strCurrentDatetime +
                      ".csv")
